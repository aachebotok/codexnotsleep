...
struct LaunchAtLoginControllerTests {
  ...
  @Test
  func appStartEnablesLaunchAtLoginForEveryUser() throws {
    let suiteName = "Methamphetamine.LaunchAtLoginTests.\(UUID().uuidString)"
    ...
    let fixtureHome = FileManager.default.temporaryDirectory.appending(
      path: "Methamphetamine.LaunchAtLoginTests.\(UUID().uuidString)",
